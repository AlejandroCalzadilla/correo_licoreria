...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Long clienteA = crearConId(crear, "CLIENTES",
                    "CIA" + seed + ",Cliente A " + seed + ",60000001,Av Cliente 1,A,cliA" + seed + ",clia" + seed
                            + "@mail.com,123456," + rolCliente);
            Long clienteB = crearConId(crear, "CLIENTES",
                    "CIB" + seed + ",Cliente B " + seed + ",60000002,Av Cliente 2,A,cliB" + seed + ",clib" + seed
                            + "@mail.com,123456," + rolCliente);
            Long clienteC = crearConId(crear, "CLIENTES",
                    "CIC" + seed + ",Cliente C " + seed + ",60000003,Av Cliente 3,A,cliC" + seed + ",clic" + seed
                            + "@mail.com,123456," + rolCliente);
             ...
             * 
             * Long ventaContado = crearConId(crear, "VENTAS", cliente +
             * ",contado,NA,efectivo");
             ...
             * ventaContado + "," + productos[idxProdVenta1] + "," + cantV1 + "," +
             * precios[idxProdVenta1]);
             * crearConId(crear, "DETALLEVENTAS",
             * ventaContado + "," + productos[idxProdVenta2] + "," + cantV2 + "," +
             * precios[idxProdVenta2]);
             ...
             * crearConId(crear, "DETALLEVENTAS",
             * ventaCredito + "," + productos[idxProdCred] + "," + cantCred + "," +
             * precios[idxProdCred]);
             ...
             * carrito + "," + productos[idxCarA] + "," + cantCarA + "," +
             * precios[idxCarA]);
             * crearConId(crear, "ITEMCARRITOS",
             * carrito + "," + productos[idxCarB] + "," + cantCarB + "," +
             * precios[idxCarB]);
             * 
             * listarEntidad(listar, "CARRITOS");
             * listarEntidad(listar, "ITEMCARRITOS");
             * crearConId(crear, "VENTASCONDETALLE", cliente + ",contado," + carrito +
             * ",NA,efectivo");
             * }
             */
    ...
    private static void seedPagoContado(Crear crear, ServiceProvider sp, Long ventaId, int dia, String seed)
            throws Exception {
        ...
        String parametrosPago = ventaId + ",efectivo," + saldo + ",Seeder Contado " + dia + ",contado." + seed + "."
                + dia + "@mail.com";
        crearConId(crear, "PAGOS", parametrosPago);
    }

    private static void seedPagosCredito(Crear crear, ServiceProvider sp, Long ventaId, int dia, String seed)
            throws Exception {
